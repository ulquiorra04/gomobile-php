...
class Buffer extends Base {
     ...
     * Send a buffer of data to be written in a file
     *
     * @param array $users [{"phoneNumber": "0707071290", "tokenMatcher": "XXXXXX"}, {"phoneNumber": "0707071290", "tokenMatcher": "XXXXXX"}]
     * @param int $scenarioId
     * @param array $options [sda => "05XXXXXXXX"]
     *
     * @return json
     */
    public function sendBulkMultipleStaticCall ($users, $scenarioId, $options = []){
        $users = json_decode($users);
